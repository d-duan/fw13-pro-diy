...
- Open Device Manager, expand Universal Serial Bus controller, right-click on all of the USB Root Hub (USB3.0) devices, and uncheck `Allow the computer to turn off this device to save power.` under Properties > Power Management tab.
